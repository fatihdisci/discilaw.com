...
instagramUrl: https://www.instagram.com/p/DWQywiSgRS3/
quickAnswer:
  intro: >-
    Yargıtay 4. Ceza Dairesi'nin kararına göre; sosyal medyada siyasetçilere yöneltilen ağır eleştiriler, kişinin onur, şeref ve saygınlığını rencide edici somut bir fiil veya olgu isnadı ya da sövme fiili içermedikçe TCK m.125 hakaret suçunu oluşturmaz. Siyasetçilere yönelik eleştirilerin sınırı, özel kişilere göre daha geniştir; ifade özgürlüğü incitici ve şoke edici düşünceleri de kapsar (AY m.26, AİHS m.10).
  highlights:
    - "<strong>Yasal dayanak:</strong> AY m.26, AİHS m.10, TCK m.125"
    - "<strong>İlke:</strong> Siyasetçi eleştirisinin sınırı daha geniştir"
    - "<strong>Suçun unsuru:</strong> Somut fiil/olgu isnadı veya sövme"
    - "<strong>Usul:</strong> Aleyhe değiştirme yasağı — CMK m.307"
---
## I. Giriş
